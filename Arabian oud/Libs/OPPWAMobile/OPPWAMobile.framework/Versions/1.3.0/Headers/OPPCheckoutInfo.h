 ...
 */
+ (nullable instancetype)checkoutInfoWithAmount:(NSDecimalNumber *)amount currencyCode:(NSString *)currencyCode tokens:(nullable NSArray<OPPToken *> *)tokens;
...
/**
 ...
 @return An OPPCheckoutInfo object, or nil if parameters are invalid.
 */
- (nullable instancetype)initWithAmount:(NSDecimalNumber *)amount currencyCode:(NSString *)currencyCode tokens:(nullable NSArray<OPPToken *> *)tokens NS_DESIGNATED_INITIALIZER;
