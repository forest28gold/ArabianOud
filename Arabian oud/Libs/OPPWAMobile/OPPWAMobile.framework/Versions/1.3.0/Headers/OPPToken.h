 ...
 */
@property (nonatomic, readonly) OPPPaymentParamsBrand paymentBrand;
...
/**
 ...
 @see OPPPaymentParamsBrand, OPPCard
 */
+ (nullable instancetype)tokenWithTokenID:(NSString *)tokenID paymentBrand:(OPPPaymentParamsBrand)paymentBrand card:(OPPCard *)card;
...
/**
 ...
 @return Returns an OPPToken object, or nil if parameters are empty.
 @see OPPPaymentParamsBrand, OPPBankAccount
 */
+ (nullable instancetype)tokenWithTokenID:(NSString *)tokenID paymentBrand:(OPPPaymentParamsBrand)paymentBrand bankAccount:(OPPBankAccount *)bankAccount;
...
/**
 ...
 @return Returns an OPPToken object, or nil if parameters are empty.
 */
- (nullable instancetype)initWithTokenID:(NSString *)tokenID paymentBrand:(OPPPaymentParamsBrand)paymentBrand card:(OPPCard *)card;
...
/**
 ...
 @see OPPPaymentParamsBrand, OPPBankAccount
 */
- (nullable instancetype)initWithTokenID:(NSString *)tokenID paymentBrand:(OPPPaymentParamsBrand)paymentBrand bankAccount:(OPPBankAccount *)bankAccount;
