...
/**
 ...
 @deprecated Use -presentCheckoutForSubmittingTransactionCompletionHandler:paymentMethodSelectedHandler:cancelHandler: instead.
...
- (void)presentCheckoutForSubmittingTransactionCompletionHandler:(void (^)(OPPTransaction * _Nullable transaction, NSError * _Nullable error))completionHandler
                                                   cancelHandler:(void (^ _Nullable )())cancelHandler DEPRECATED_MSG_ATTRIBUTE("- Use -presentCheckoutForSubmittingTransactionCompletionHandler:paymentMethodSelectedHandler:cancelHandler:");

/**
 Opens an in-App payment page for collecting user input and submitting a transaction. First the list of payment methods from the checkout settings will be displayed.
 @param completionHandler A block executed when the transaction is completed. You need to send the request to your server to get the transaction status.
 @param paymentMethodSelectedHandler A block executed when the shopper selected payment method. You need to obtain a new checkout Id if the selected payment method requires another payment type and return the value to SDK or nil in case of error using completion block.
 @param cancelHandler A block executed if the user closes the payment page prematurely.
 */
- (void)presentCheckoutForSubmittingTransactionCompletionHandler:(void (^)(OPPTransaction * _Nullable transaction, NSError * _Nullable error))completionHandler
