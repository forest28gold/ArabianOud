 ...
 */
+ (nullable instancetype)chinaUnionPayPaymentParamsWithCheckoutID:(NSString *)checkoutID holder:(NSString *)holder error:(NSError **)error;
...
/**
 ...
 @return Returns an object representing a China UnionPay transaction.
 */
- (nullable instancetype)initWithCheckoutID:(NSString *)checkoutID holder:(NSString *)holder error:(NSError **)error NS_DESIGNATED_INITIALIZER;
